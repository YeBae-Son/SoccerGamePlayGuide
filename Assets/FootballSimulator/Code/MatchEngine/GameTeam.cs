...
namespace FStudio.MatchEngine {
    public class GameTeam : MonoBehaviour {
        ...
        public void Behave(
            ...
            if (m_nextName < time) {
                ...
                foreach (var player in showName) {
                    ...
                    player.PlayerController.CUI.ShowName(true);//^^7
                    //player.PlayerController.CUI.SetColor();
                    //Debug.Log("before for eachhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
                    /*if (MatchManager.Current.stage_1 == true || MatchManager.Current.stage_2 == true)
                    {
                        Debug.Log("foreachhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
                        player.PlayerController.CUI.SetColor();
                    }*/ //^^7 여기야여기
                }
                ...
                foreach (var player in hideName) {
                    ...
                    player.PlayerController.CUI.ShowName(false);
                }
        ...
        public void PrePositionForOffensiveKickOff(
            ...
            var orderedBasePositions = KickOffPositioning_Starter.Current.FieldPositions.OrderBy(x => x.VerticalPlacement).ToArray(); //KickOffStage1_Starter
        ...
        //^^7 스킬게임 킥오프 - Stage1
        public void PrePositionDefensiveStage1(
            in int fieldEndX,
            in int fieldEndY,
            GoalNet goalNet)
        {
            ...
            var orderedBasePositions = KickOffStage1.Current.FieldPositions.OrderBy(x => x.VerticalPlacement).ToArray();
        ...
        public void PrePositionForStage1(
            int fieldEndX,
            int fieldEndY,
            GoalNet goalNet,
            Vector3 kickerPositioningOffset = default,
            Positions excludePosition = Positions.ParametersCount)
        {
            ...
            var orderedBasePositions = KickOffStage1_Starter.Current.FieldPositions.OrderBy(x => x.VerticalPlacement).ToArray(); //KickOffStage1_Starter
        ...
        //^^7 Stage2
        public void PrePositionDefensiveStage2(
            in int fieldEndX,
            in int fieldEndY,
            GoalNet goalNet)
        {
            ...
            var orderedBasePositions = KickOffStage2.Current.FieldPositions.OrderBy(x => x.VerticalPlacement).ToArray();
        ...
        public void PrePositionForStage2(
            int fieldEndX,
            int fieldEndY,
            GoalNet goalNet,
            Vector3 kickerPositioningOffset = default,
            Positions excludePosition = Positions.ParametersCount)
        {
            ...
            var orderedBasePositions = KickOffStage2_Starter.Current.FieldPositions.OrderBy(x => x.VerticalPlacement).ToArray(); //KickOffStage1_Starter
